...
// Source: github.com/bryanl/activeinformer/pkg/kubernetes (interfaces: Store)
...
func (m *MockStore) List(arg0 schema.GroupVersionResource, arg1 kubernetes.ListOptions) (*unstructured.UnstructuredList, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) Watch(arg0 schema.GroupVersionResource, arg1 kubernetes.ListOptions) (kubernetes.Watch, error) {
	m.ctrl.T.Helper()
